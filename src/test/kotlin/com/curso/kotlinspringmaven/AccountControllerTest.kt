...
class AccountControllerTest {
    ...
    @Test
    fun `test find all`(){
        accountRepository.save(Account(name = "Ederson", document = "12345", phone = "123"))
    ...
    @Test
    fun `test find by id`(){
        val account = accountRepository.save(Account(name = "Ederson", document = "12345", phone = "123"))
    ...
    fun `test create account`(){
        val account = Account(name = "Ederson", document = "12345", phone = "123")
...
//            .andExpect(MockMvcResultMatchers.jsonPath("\$.id").value(account.id))
    ...
    fun `test update account`(){
        val account = accountRepository
            .save(Account(name = "Ederson", document = "12345", phone = "123"))
            .copy(name = "Updated")
